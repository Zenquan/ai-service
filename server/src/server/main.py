...
from server.api import ask, auth, customer_service, docs, health, ingest, metrics, metrics_summary, alerts
...
app.include_router(metrics_summary.router, prefix=API_PREFIX, tags=["metrics"])
